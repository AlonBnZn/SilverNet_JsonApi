...
{
    public class When_Calling_Update_With_Invalid_Name : TenantControllerSpecificationBase
    {
        ...
        public void Should_Not_Update_Tenant()
        {
            ...
            _response.Errors[0].Detail.Should().Be("name cannot exceed 20 characters.");
        }
    }
}
