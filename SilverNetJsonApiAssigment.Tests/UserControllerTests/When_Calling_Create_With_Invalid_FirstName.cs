...
{
    public class When_Calling_Create_With_Invalid_FirstName : UserControllerSpecificationBase
    {
        ...
        public void Should_Return_UnproccessableEntity()
        {
            ...
            _response.Errors[0].Detail.Should().Be("The FirstName field is required.");
        }
    }
}
