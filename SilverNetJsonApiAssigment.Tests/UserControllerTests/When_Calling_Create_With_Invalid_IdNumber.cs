...
{
    public class When_Calling_Create_With_Invalid_IdNumber : UserControllerSpecificationBase
    {
        ...
        public void It_Should_Return_UnproccessableEntity()
        {
            ...
            _response.Errors[0].Detail.Should().Be("The IdNumber field is required.");
        }
    }
}
