...
{
    public class When_Calling_Update_With_Invalid_FirstName : UserControllerSpecificationBase
    {
        ...
        public void Should_Not_Update_User()
        {
            ...
            _response.Errors[0].Detail.Should().Be("firstName cannot exceed 10 characters.");
        }
    }
}
